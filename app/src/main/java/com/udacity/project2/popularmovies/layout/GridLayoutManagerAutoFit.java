package com.udacity.project2.popularmovies.layout;
...
public  class GridLayoutManagerAutoFit extends GridLayoutManager {
    ...
    public GridLayoutManagerAutoFit(Context context, int columnWidth, int orientation, boolean reverseLayout) {
